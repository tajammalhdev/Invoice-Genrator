...
const InvoiceTemplate1 = ({ data }: { data: any }) => {
		...
		<InvoiceLayout data={data}>
			...
			<div className="flex justify-between items-start border-b pb-6 mb-8">
				...
				<div className="text-right">
					...
					<address className="mt-4 not-italic text-gray-700 leading-relaxed">
			...
			<div className="grid sm:grid-cols-2 gap-8 mb-8">
				<div>
					...
					<address className="mt-1 text-sm not-italic text-gray-500 leading-relaxed">
						{invoice.client.address && (
							<span>
								{invoice.client.address}
								<br />
				...
				<div className="sm:text-right space-y-2">
					<dl className="flex justify-between sm:justify-end sm:gap-8">
						<dt className="font-semibold text-gray-800">Invoice date:</dt>
			...
			<div className="mt-8 flex justify-end">
				<div className="w-full max-w-md space-y-2 text-sm">
					...
					<dl className="flex justify-between border-t pt-3">
			...
			<div className="mt-10 text-center text-xs text-gray-500">
				...
				<p>Please make payment within the due date.</p>
			</div>
		</InvoiceLayout>
	);
};
